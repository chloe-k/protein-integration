...
res_pa_G_RF_11 <- fit.classification(y=y, samples = samples, datapath = datapath, respath = respath, profile_name = profile_name,
                                  method = "DRW", pranking = "t-test", classifier = "rf",
                                  nFolds = 5, numTops=50, iter = 50)

save(res_pa_G_RF_11, file=file.path('data/model/res_pa_G_RF_11.RData'))

summary(res_pa_G_RF_11)
print(res_pa_G_RF_11$results)
print(res_pa_G_RF_11$resample$Accuracy)

write.SigFeatures(res_fit=res_pa_G_RF_11, profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_M_RF_11 <- fit.classification(y=y, samples = samples, datapath = datapath, respath = respath, profile_name = profile_name,
                                  method = "DRW", pranking = "t-test", classifier = "rf",
                                  nFolds = 5, numTops=50, iter = 50)

save(res_pa_M_RF_11, file=file.path('data/model/res_pa_M_RF_11.RData'))

summary(res_pa_M_RF_11)
print(res_pa_M_RF_11$results)
print(res_pa_M_RF_11$resample$Accuracy)

write.SigFeatures(res_fit=res_pa_M_RF_11, profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_R_RF_11 <- fit.classification(y=y, samples = samples, datapath = datapath, respath = respath, profile_name = profile_name,
                                  method = "DRW", pranking = "t-test", classifier = "rf",
                                  nFolds = 5, numTops=50, iter = 50)

save(res_pa_R_RF_11, file=file.path('data/model/res_pa_R_RF_11.RData'))

summary(res_pa_R_RF_11)
print(res_pa_R_RF_11$results)
print(res_pa_R_RF_11$resample$Accuracy)

write.SigFeatures(res_fit=res_pa_R_RF_11, profile_name=profile_name, method="DRW", respath=respath)
