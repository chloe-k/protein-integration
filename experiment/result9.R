...
# Extract the protein(node) which is corresponding to RPPA protein and its neighbor node(PPI has 8 relations)
...
perf_boxplot(xlabs, res_models, perf_min = 0.5, perf_max = 0.9, res_pa_GM_RF_9$results$Accuracy[1])
