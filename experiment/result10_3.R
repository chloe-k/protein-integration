...
res_pa_GM_10_3 <- fit.classification(y=y, samples = samples, id="result10_3", datapath = datapath, respath = respath, profile_name = profile_name,
                                     method = "DRW", pranking = "t-test", classifier = "rf",
                                     nFolds = 5, numTops=50, iter = 50)

save(res_pa_GM_10_3, file=file.path('data/model/res_pa_GM_10_3.RData'))

summary(res_pa_GM_10_3)
print(res_pa_GM_10_3$results)
print(res_pa_GM_10_3$resample$Accuracy)

write.SigFeatures(res_fit=res_pa_GM_10_3, id="result10_3", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMR_10_3 <- fit.classification(y=y, samples = samples, id="result10_3", datapath = datapath, respath = respath, profile_name = profile_name,
                                      method = "DRW", pranking = "t-test", classifier = "rf",
                                      nFolds = 5, numTops=50, iter = 50)

save(res_pa_GMR_10_3, file=file.path('data/model/res_pa_GMR_10_3.RData'))

summary(res_pa_GMR_10_3)
print(res_pa_GMR_10_3$results)
print(res_pa_GMR_10_3$resample$Accuracy)

write.SigFeatures(res_fit=res_pa_GMR_10_3, id="result10_3", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMR_d_10_3 <- fit.classification(y=y, samples = samples, id="result10_3", datapath = datapath, respath = respath, profile_name = profile_name,
                                        method = "DRW", pranking = "t-test", classifier = "rf",
                                        nFolds = 5, numTops=50, iter = 50)

save(res_pa_GMR_d_10_3, file=file.path('data/model/res_pa_GMR_d_10_3.RData'))

summary(res_pa_GMR_d_10_3)
print(res_pa_GMR_d_10_3$results)
print(res_pa_GMR_d_10_3$resample$Accuracy)

write.SigFeatures(res_fit=res_pa_GMR_d_10_3, id="result10_3", profile_name=profile_name, method="DRW", respath=respath)
...
res_models <- list(res_pa_GM_10_3, res_pa_GMR_10_3, res_pa_GMR_d_10_3, res_pa_GMP_10_3)

perf_boxplot(title, xlabs, res_models, perf_min = 0.5, perf_max = 0.9, res_pa_GM_10_3$results$Accuracy[1])