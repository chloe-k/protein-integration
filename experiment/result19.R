...
fit.iDRWPClass(x=x, y=y, globalGraph=gm, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.01", Gamma = Gamma,
               pranking = "t-test", mode = "GM", AntiCorr=FALSE, DEBUG=TRUE)

res_pa_GM_19_0.01 <- fit.classification(y=y, samples = samples, id = "result19_0.01", datapath = datapath, respath = respath, profile_name = profile_name,
...
write.SigFeatures(res_fit=res_pa_GM_19_0.01, id = "result19_0.01", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMR_19_0.01 <- fit.classification(y=y, samples = samples, id = "result19_0.01", datapath = datapath, respath = respath, profile_name = profile_name,
                                    method = "DRW", pranking = "t-test", classifier = "rf",
                                    nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GMR_19_0.01, id = "result19_0.01", profile_name=profile_name, method="DRW", respath=respath)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gmr, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.01", prob = prob, Gamma = Gamma,
               pranking = "t-test", mode = "GMP", AntiCorr=FALSE, DEBUG=TRUE)

res_pa_GMR_d_19_0.01 <- fit.classification(y=y, samples = samples, id = "result19_0.01", datapath = datapath, respath = respath, profile_name = profile_name,
                                           method = "DRW", pranking = "t-test", classifier = "rf",
                                           nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GMR_d_19_0.01, id = "result19_0.01", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMP_19_0.01 <- fit.classification(y=y, samples = samples, id = "result19_0.01", datapath = datapath, respath = respath, profile_name = profile_name,
                                         method = "DRW", pranking = "t-test", classifier = "rf",
                                         nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GMP_19_0.01, id = "result19_0.01", profile_name=profile_name, method="DRW", respath=respath)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gm, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.05", Gamma = Gamma,
               pranking = "t-test", mode = "GM", AntiCorr=FALSE, DEBUG=TRUE)

res_pa_GM_19_0.05 <- fit.classification(y=y, samples = samples, id = "result19_0.05", datapath = datapath, respath = respath, profile_name = profile_name,
                                        method = "DRW", pranking = "t-test", classifier = "rf",
                                        nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GM_19_0.05, id = "result19_0.05", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMR_19_0.05 <- fit.classification(y=y, samples = samples, id = "result19_0.05", datapath = datapath, respath = respath, profile_name = profile_name,
                                         method = "DRW", pranking = "t-test", classifier = "rf",
                                         nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GMR_19_0.05, id = "result19_0.05", profile_name=profile_name, method="DRW", respath=respath)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gmr, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.05", prob = prob, Gamma = Gamma,
               pranking = "t-test", mode = "GMP", AntiCorr=FALSE, DEBUG=TRUE)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gm, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.1", Gamma = Gamma,
               pranking = "t-test", mode = "GM", AntiCorr=FALSE, DEBUG=TRUE)

res_pa_GM_19_0.1 <- fit.classification(y=y, samples = samples, id = "result19_0.1", datapath = datapath, respath = respath, profile_name = profile_name,
                                        method = "DRW", pranking = "t-test", classifier = "rf",
                                        nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GM_19_0.1, id = "result19_0.1", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMR_19_0.1 <- fit.classification(y=y, samples = samples, id = "result19_0.1", datapath = datapath, respath = respath, profile_name = profile_name,
                                         method = "DRW", pranking = "t-test", classifier = "rf",
                                         nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GMR_19_0.1, id = "result19_0.1", profile_name=profile_name, method="DRW", respath=respath)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gmr, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.1", prob = prob, Gamma = Gamma,
               pranking = "t-test", mode = "GMP", AntiCorr=FALSE, DEBUG=TRUE)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gm, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.2", Gamma = Gamma,
               pranking = "t-test", mode = "GM", AntiCorr=FALSE, DEBUG=TRUE)

res_pa_GM_19_0.2 <- fit.classification(y=y, samples = samples, id = "result19_0.2", datapath = datapath, respath = respath, profile_name = profile_name,
                                        method = "DRW", pranking = "t-test", classifier = "rf",
                                        nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GM_19_0.2, id = "result19_0.2", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMR_19_0.2 <- fit.classification(y=y, samples = samples, id = "result19_0.2", datapath = datapath, respath = respath, profile_name = profile_name,
                                         method = "DRW", pranking = "t-test", classifier = "rf",
                                         nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GMR_19_0.2, id = "result19_0.2", profile_name=profile_name, method="DRW", respath=respath)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gmr, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.2", prob = prob, Gamma = Gamma,
               pranking = "t-test", mode = "GMP", AntiCorr=FALSE, DEBUG=TRUE)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gm, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.3", Gamma = Gamma,
               pranking = "t-test", mode = "GM", AntiCorr=FALSE, DEBUG=TRUE)

res_pa_GM_19_0.3 <- fit.classification(y=y, samples = samples, id = "result19_0.3", datapath = datapath, respath = respath, profile_name = profile_name,
                                        method = "DRW", pranking = "t-test", classifier = "rf",
                                        nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GM_19_0.3, id = "result19_0.3", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMR_19_0.3 <- fit.classification(y=y, samples = samples, id = "result19_0.3", datapath = datapath, respath = respath, profile_name = profile_name,
                                         method = "DRW", pranking = "t-test", classifier = "rf",
                                         nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GMR_19_0.3, id = "result19_0.3", profile_name=profile_name, method="DRW", respath=respath)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gmr, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.3", prob = prob, Gamma = Gamma,
               pranking = "t-test", mode = "GMP", AntiCorr=FALSE, DEBUG=TRUE)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gm, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.4", Gamma = Gamma,
               pranking = "t-test", mode = "GM", AntiCorr=FALSE, DEBUG=TRUE)

res_pa_GM_19_0.4 <- fit.classification(y=y, samples = samples, id = "result19_0.4", datapath = datapath, respath = respath, profile_name = profile_name,
                                        method = "DRW", pranking = "t-test", classifier = "rf",
                                        nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GM_19_0.4, id = "result19_0.4", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMR_19_0.4 <- fit.classification(y=y, samples = samples, id = "result19_0.4", datapath = datapath, respath = respath, profile_name = profile_name,
                                         method = "DRW", pranking = "t-test", classifier = "rf",
                                         nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GMR_19_0.4, id = "result19_0.4", profile_name=profile_name, method="DRW", respath=respath)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gmr, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.4", prob = prob, Gamma = Gamma,
               pranking = "t-test", mode = "GMP", AntiCorr=FALSE, DEBUG=TRUE)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gm, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.5", Gamma = Gamma,
               pranking = "t-test", mode = "GM", AntiCorr=FALSE, DEBUG=TRUE)

res_pa_GM_19_0.5 <- fit.classification(y=y, samples = samples, id = "result19_0.5", datapath = datapath, respath = respath, profile_name = profile_name,
                                        method = "DRW", pranking = "t-test", classifier = "rf",
                                        nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GM_19_0.5, id = "result19_0.5", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMR_19_0.5 <- fit.classification(y=y, samples = samples, id = "result19_0.5", datapath = datapath, respath = respath, profile_name = profile_name,
                                         method = "DRW", pranking = "t-test", classifier = "rf",
                                         nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GMR_19_0.5, id = "result19_0.5", profile_name=profile_name, method="DRW", respath=respath)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gmr, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.5", prob = prob, Gamma = Gamma,
               pranking = "t-test", mode = "GMP", AntiCorr=FALSE, DEBUG=TRUE)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gm, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.6", Gamma = Gamma,
               pranking = "t-test", mode = "GM", AntiCorr=FALSE, DEBUG=TRUE)

res_pa_GM_19_0.6 <- fit.classification(y=y, samples = samples, id = "result19_0.6", datapath = datapath, respath = respath, profile_name = profile_name,
                                        method = "DRW", pranking = "t-test", classifier = "rf",
                                        nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GM_19_0.6, id = "result19_0.6", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMR_19_0.6 <- fit.classification(y=y, samples = samples, id = "result19_0.6", datapath = datapath, respath = respath, profile_name = profile_name,
                                         method = "DRW", pranking = "t-test", classifier = "rf",
                                         nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GMR_19_0.6, id = "result19_0.6", profile_name=profile_name, method="DRW", respath=respath)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gmr, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.6", prob = prob, Gamma = Gamma,
               pranking = "t-test", mode = "GMP", AntiCorr=FALSE, DEBUG=TRUE)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gm, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.7", Gamma = Gamma,
               pranking = "t-test", mode = "GM", AntiCorr=FALSE, DEBUG=TRUE)

res_pa_GM_19_0.7 <- fit.classification(y=y, samples = samples, id = "result19_0.7", datapath = datapath, respath = respath, profile_name = profile_name,
                                        method = "DRW", pranking = "t-test", classifier = "rf",
                                        nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GM_19_0.7, id = "result19_0.7", profile_name=profile_name, method="DRW", respath=respath)
...
res_pa_GMR_19_0.7 <- fit.classification(y=y, samples = samples, id = "result19_0.7", datapath = datapath, respath = respath, profile_name = profile_name,
                                         method = "DRW", pranking = "t-test", classifier = "rf",
                                         nFolds = 5, numTops=50, iter = 50)
...
write.SigFeatures(res_fit=res_pa_GMR_19_0.7, id = "result19_0.7", profile_name=profile_name, method="DRW", respath=respath)
...
fit.iDRWPClass(x=x, y=y, globalGraph=gmr, testStatistic= testStatistic, profile_name = profile_name,
               datapath = datapath, respath = respath, pathSet=pathSet, method = "DRW", samples = samples, id = "result19_0.7", prob = prob, Gamma = Gamma,
               pranking = "t-test", mode = "GMP", AntiCorr=FALSE, DEBUG=TRUE)
